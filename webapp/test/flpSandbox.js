		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Citrosuco",
									"targetURL": "#comlab2devcitrosuco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devcitrosuco-display": {
								"semanticObject": "comlab2devcitrosuco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.citrosuco",
									"url": sap.ui.require.toUrl("com/lab2dev/citrosuco")
								}
							}
						}
					}
